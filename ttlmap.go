...
func (m *TtlMap) Set(key string, value *rate.Limiter, ttlSeconds int) error {
...
func (m *TtlMap) Get(key string) (*rate.Limiter, bool) {
...
func (m *TtlMap) set(key string, value *rate.Limiter, expiryTime int) error {
...
func (m *TtlMap) lockNGet(key string) (value *rate.Limiter, mapEl *mapElement, expired bool) {
	if m.mutex != nil {
		m.mutex.RLock()
		defer m.mutex.RUnlock()
	}
